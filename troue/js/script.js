(function($) {
    ...
    function preloader() {
        if($('.preloader').length) {
            $('.preloader').delay(10).fadeOut(400, function() {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2023/12/09', function(event) {
  ...
  // This function plays or pauses the audio when the button is clicked
  ...
  var button = document.querySelector('.music-box-toggle-btn');
